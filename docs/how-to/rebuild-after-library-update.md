...
wright resolve libfoo --rdeps | wright build --force --package --print-parts | wright install
```
...
```bash
wright resolve libfoo --rdeps=all --depth=0 | wright build --force --package --print-parts | wright install
```

## Limit Cascade Depth

```bash
wright resolve libfoo --rdeps --depth=2 | wright build --force --package --print-parts | wright install
```
